...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Welcome to katoki v3 super");
        ...
        System.out.println("katokiV3supper by trangiahung");
        ...
        System.out.println("katokiV3 starting attack");
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("katokiV3supper: " + responseCode + "Thread: " + this.seq);
    }
